 ...
 *   <li>{@link com.rockwellcollins.spear.Specification#getAssumptionsKeyword <em>Assumptions Keyword</em>}</li>
 *   <li>{@link com.rockwellcollins.spear.Specification#getAssumptions <em>Assumptions</em>}</li>
 *   <li>{@link com.rockwellcollins.spear.Specification#getRequirementsKeyword <em>Requirements Keyword</em>}</li>
 *   <li>{@link com.rockwellcollins.spear.Specification#getRequirements <em>Requirements</em>}</li>
 *   <li>{@link com.rockwellcollins.spear.Specification#getPropertiesKeyword <em>Properties Keyword</em>}</li>
...
public interface Specification extends File
{
  ...
  /**
   * Returns the value of the '<em><b>Assumptions Keyword</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Assumptions Keyword</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Assumptions Keyword</em>' attribute.
   * @see #setAssumptionsKeyword(String)
   * @see com.rockwellcollins.spear.SpearPackage#getSpecification_AssumptionsKeyword()
   * @model
   * @generated
   */
  String getAssumptionsKeyword();

  /**
   * Sets the value of the '{@link com.rockwellcollins.spear.Specification#getAssumptionsKeyword <em>Assumptions Keyword</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Assumptions Keyword</em>' attribute.
   * @see #getAssumptionsKeyword()
   * @generated
   */
  void setAssumptionsKeyword(String value);
  ...
  /**
   * Returns the value of the '<em><b>Requirements Keyword</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Requirements Keyword</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Requirements Keyword</em>' attribute.
   * @see #setRequirementsKeyword(String)
   * @see com.rockwellcollins.spear.SpearPackage#getSpecification_RequirementsKeyword()
   * @model
   * @generated
   */
  String getRequirementsKeyword();

  /**
   * Sets the value of the '{@link com.rockwellcollins.spear.Specification#getRequirementsKeyword <em>Requirements Keyword</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Requirements Keyword</em>' attribute.
   * @see #getRequirementsKeyword()
   * @generated
   */
  void setRequirementsKeyword(String value);
  ...
  /**
   * Returns the value of the '<em><b>Properties Keyword</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Properties Keyword</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Properties Keyword</em>' attribute.
   * @see #setPropertiesKeyword(String)
   * @see com.rockwellcollins.spear.SpearPackage#getSpecification_PropertiesKeyword()
   * @model
   * @generated
   */
  String getPropertiesKeyword();

  /**
   * Sets the value of the '{@link com.rockwellcollins.spear.Specification#getPropertiesKeyword <em>Properties Keyword</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Properties Keyword</em>' attribute.
   * @see #getPropertiesKeyword()
   * @generated
   */
  void setPropertiesKeyword(String value);
