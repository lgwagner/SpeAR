...
public class SSpecification extends SMapElement {
  ...
  public Node toBaseLustre() {
    ...
    /*
     * We must add: 1. the true inputs 2. the shadow inputs for the outputs 3.
     * the shadow inputs for the state 4. the args from any calls that also need
     * shadow inputs 5. the args from any calls, calls that need shadow args
     */
