...
public class SProgram extends SMapElement {
  ...
  private SProgram(Document d, File main) {
    ...
    // just get the names of these because we need to have them in the namespace
    ...
    /*
     * process the specifications in three steps 1. build them 2. resolve the
     * calls among them 3. resolve the call variables
     */
  ...
  private SProgram(Document d, Pattern main) {
    ...
    // then add the patterns (because they have local scope that could conflict
    // with global scope)
