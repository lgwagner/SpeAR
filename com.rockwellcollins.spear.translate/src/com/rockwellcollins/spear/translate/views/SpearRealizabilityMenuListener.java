 ...
 */
public class SpearRealizabilityMenuListener implements IMenuListener {
	private final AnalysisResultColumnViewer columnViewer;
	private Layout layout;
	private IWorkbenchWindow window;

	public SpearRealizabilityMenuListener(IWorkbenchWindow window, AnalysisResultTable columnViewer) {
		this.window = window;
