...
public class GeneratePDF implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		...
		// MessageDialog.openError(window.getShell(), "Error", "Only SpeAR files
		// can
		// be analyzed.");
		// return;
		// }
		...
		// state.getContents().get(0);
		//
		// if (ActionUtilities.hasErrors(specification.eResource())) {
		// MessageDialog.openError(window.getShell(), "Error", "Specification
		// contains errors.");
		// return null;
		// }
		//
		...
		// IResource pdfResource = root.getFile(new
		// Path(pdfURI.toPlatformString(true)));
		//
		...
		// MessageDialog.openError(window.getShell(), "Unsupported Feature",
		// "This
