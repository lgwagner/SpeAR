		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAtomicExprAccess().getGroup_7_4(), "rule__AtomicExpr__Group_7_4__0");
					...
					put(grammarAccess.getPatternAccess().getEquationsAssignment_13_0(), "rule__Pattern__EquationsAssignment_13_0");
					put(grammarAccess.getPatternAccess().getPropertiesAssignment_13_1(), "rule__Pattern__PropertiesAssignment_13_1");
					put(grammarAccess.getPatternAccess().getAssertionsAssignment_13_2(), "rule__Pattern__AssertionsAssignment_13_2");
					...
					put(grammarAccess.getAtomicExprAccess().getArgsAssignment_7_3(), "rule__AtomicExpr__ArgsAssignment_7_3");
					put(grammarAccess.getAtomicExprAccess().getArgsAssignment_7_4_1(), "rule__AtomicExpr__ArgsAssignment_7_4_1");
